...
ALTER TABLE public.users REPLICA IDENTITY FULL; -- Send "previous data" to khulnasoft
...
ALTER TABLE public.messages REPLICA IDENTITY FULL; -- Send "previous data" to khulnasoft
